...
As the title indicates, it is *A History of Archival Practice*, rather than history of archives, and it explores the different ways that the archival function has been performed through history. Delsalle's motivation for writing the book was what he saw as an 'identity crisis of the archival profession' (p. x). Some archivists he argued, saw themselves as keepers of old records - just managing extant, static collections. Others worked actively with creating officers to negotiate transfers and then managed those records in custody. Yet others wanted a cl

"crisis of identity can probably be explained by a lack of a reference framework"? i.e. to Q what is an archivist - a keeper of old records (those who manage extant collections), those who negotiate transfers with creating offices then manage those records; those who advocate splitting archivists from records managers. Understand foundations can help - a reference framework
identity crisis archival profession - archivists as the keepers of extant collections; archivists who work closely with creating offices on transfers and then care for that material; and a third that wants to separate those roles into two professions: archivist and records manager. To resolve this need a 'reference framework' view of archivists and records managers as a split profession. To resolve this need to find our roots. As Procter puts it in her introduction, the work '[takes] the long view of the value of the archival role' (p. xv).
